...
(define (install-polynomial-term-package) 
    ...
    (define (make-polynomial-dense var terms) 
        (make-polynomial var (cons 'dense terms))) 
    (define (make-polynomial-sparse var terms) 
        (make-polynomial var (cons 'sparse (map cadr terms))))
...
(define (make-polynomial-dense v t)
    ((get 'make-polynomial 'dense) v t))

(define x (make-polynomial-dense 'x '(1 2 5 4)))